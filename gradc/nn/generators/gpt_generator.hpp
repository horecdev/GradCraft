...
namespace gradc {
    ...
    struct GPTGenerator {
        public:
            static std::string run_inference(GPT<T>& gpt, BytePairEncoding& bpe, int64_t context_length, const std::string& start_text, int64_t max_tokens, int64_t num_sequences, Device cpu, Device infer_device, std::optional<float> temperature) {
